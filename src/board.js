    ...
    <>
      {modal && (
        <div className="add-task">
          <div className="text-center bg-gradient-to-br from-red-500 via-transparent to-blue-500 p-6 rounded-xl shadow">
      ...
      <div className="flex gap-4 w-full flex-wrap">
        <div
          className="w-72 h-auto bg-slate-400 rounded-md p-2 shadow"
        ...
        <div
          className="w-72 h-auto bg-amber-600 rounded-md p-2 shadow"
          onDragOver={handleDragOver}
        ...
        <div
          className="w-72 h-auto bg-red-500 rounded-md p-2 shadow"
          onDragOver={handleDragOver}
        ...
        <div
          className="w-72 h-auto bg-rose-300 rounded-md p-2 shadow"
          onDragOver={handleDragOver}
        ...
        <div
          className="w-72 h-auto bg-slate-300 rounded-md p-2 shadow"
          onDragOver={handleDragOver}
        ...
        <div
          className="w-72 h-auto bg-cyan-300 rounded-md p-2 shadow"
          onDragOver={handleDragOver}
